...
//from homework 6, archived old algorithms
package Homework.HW5Transformations;

import Homework.HW6ArbitraryRotation.Lines;
import Homework.HW6ArbitraryRotation.SurfaceNormal;
...
public class SceneGraphOld {
    ...
    public void render(int[][] framebuffer) { //add grey for cube
        ...
        //top (default): 0, 1, 2, 3
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][0], (int)scene[1][0], (int)scene[0][1], (int)scene[1][1], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][1], (int)scene[1][1], (int)scene[0][2], (int)scene[1][2], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][2], (int)scene[1][2], (int)scene[0][3], (int)scene[1][3], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][3], (int)scene[1][3], (int)scene[0][0], (int)scene[1][0], framebuffer);

        //front: 3, 2, 6, 7
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][3], (int)scene[1][3], (int)scene[0][2], (int)scene[1][2], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][2], (int)scene[1][2], (int)scene[0][6], (int)scene[1][6], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][6], (int)scene[1][6], (int)scene[0][7], (int)scene[1][7], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][7], (int)scene[1][7], (int)scene[0][3], (int)scene[1][3], framebuffer);

        //bottom: 7, 6, 5, 4
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][7], (int)scene[1][7], (int)scene[0][6], (int)scene[1][6], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][6], (int)scene[1][6], (int)scene[0][5], (int)scene[1][5], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][5], (int)scene[1][5], (int)scene[0][4], (int)scene[1][4], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][4], (int)scene[1][4], (int)scene[0][7], (int)scene[1][7], framebuffer);

        //back: 4, 5, 1, 0
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][4], (int)scene[1][4], (int)scene[0][5], (int)scene[1][5], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][5], (int)scene[1][5], (int)scene[0][1], (int)scene[1][1], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][1], (int)scene[1][1], (int)scene[0][0], (int)scene[1][0], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][0], (int)scene[1][0], (int)scene[0][4], (int)scene[1][4], framebuffer);

        //right: 2, 1, 5, 6
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][2], (int)scene[1][2], (int)scene[0][1], (int)scene[1][1], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][1], (int)scene[1][1], (int)scene[0][5], (int)scene[1][5], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][5], (int)scene[1][5], (int)scene[0][6], (int)scene[1][6], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][6], (int)scene[1][6], (int)scene[0][2], (int)scene[1][2], framebuffer);

        //left: 0, 3, 7, 4
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][0], (int)scene[1][0], (int)scene[0][3], (int)scene[1][3], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][3], (int)scene[1][3], (int)scene[0][7], (int)scene[1][7], framebuffer);
        Homework.HW6ArbitraryRotation.Lines.bresenhamForm((int)scene[0][7], (int)scene[1][7], (int)scene[0][4], (int)scene[1][4], framebuffer);
    ...
    public static void setSurfaceNormals(int o, int a, int b, int i) {
        ...
        double[] cross = Homework.HW6ArbitraryRotation.SurfaceNormal.cross(vectorSub(a, o), vectorSub(b, o));
